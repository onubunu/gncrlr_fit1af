...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { p_brand: @phone.p_brand, p_comment: @phone.p_comment, p_image_url: @phone.p_image_url, p_price: @phone.p_price, p_typ: @phone.p_typ }
    end
  ...
  test "should update phone" do
    put :update, id: @phone, phone: { p_brand: @phone.p_brand, p_comment: @phone.p_comment, p_image_url: @phone.p_image_url, p_price: @phone.p_price, p_typ: @phone.p_typ }
    assert_redirected_to phone_path(assigns(:phone))
  end
